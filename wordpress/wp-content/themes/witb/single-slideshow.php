<?php
/**
 * The Template for displaying feature articles.
 *
 * @package WordPress
 * @subpackage Starkers
 * @since Starkers 3.0
...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo('template_directory'); ?>/assets/css/areas/slideshow.css" />
	
<div class="span8">
	<div class="row">
		<h2 class="page-title"><img src="<?php bloginfo('template_directory'); ?>/assets/img/titles/title-home.png" alt="Store"></h2>
		<div class="span8">
